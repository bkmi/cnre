...
### small
python main.py task=two_moons,slcp,gaussian_mixture max_num_epochs=1000 algorithm=cnre data=prior data.num_simulations=22_528 data.validation_fraction=0.090909 algorithm.params.state_dict_saving_rate=100 algorithm.params.K=1,9,24,49,74,99,149,199 device=cuda:0 hydra/launcher=das5-gpu hydra.launcher.timeout_min=600 --multirun
## joint
### big
