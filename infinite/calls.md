...
# details
python main.py task=bernoulli_glm,lotka_volterra,slcp,gaussian_mixture,gaussian_linear_uniform,two_moons,gaussian_linear,sir,slcp_distractors,bernoulli_glm_raw max_num_epochs=10 algorithm=cnre data=bench data.num_simulations=1_000 algorithm.params.K=1 device=cuda:0 compute_metrics=false --multirun
...
slcp, - good
gaussian_mixture, - good
gaussian_linear_uniform, - good
two_moons, - good
gaussian_linear, - good
sir, - julia
